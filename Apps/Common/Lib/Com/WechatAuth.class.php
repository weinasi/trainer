...
class WechatAuth {
     ...
     * @var string
     */
    private $appId = 'wxdbdbc123c8c30b45';

    /**
     * 微信开发者申请的appSecret
     * @var string
     */
    private $appSecret = '3312eb2026a006bd0cc39af3021ef9c5';
    ...
    private $snsApiURL = 'https://api.weixin.qq.com/sns/oauth2/access_token';
    ...
    public function getBaseInfo($code){
    	...
    	$info = self::http("{$this->snsApiURL}", $query);
    	return $info;
    }
    
    //从微信上获取用户基本信息
    public function getBasicUserInfo($openid, $lang = 'zh_CN'){
    	$query = array(
